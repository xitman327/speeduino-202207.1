  ...
  switch (boardID)
  {
    ...
    case 3:
     ...
     //Pin definitions for experimental board Tjeerd 
        ...
        pinInjector1 = PA15; //Output pin injector 1 is on
        pinInjector2 = PB3; //Output pin injector 2 is on
        pinInjector3 = PB4; //Output pin injector 3 is on 
        pinInjector4 = PB5; //Output pin injector 4 is on
        ...
        pinMAP = PA4; //MAP sensor pin
        pinIAT = PA5; //IAT sensor pin
        pinCLT = PA6; //CLS sensor pin
        pinO2 = PA7; //O2 Sensor pin
        pinBat = PB0; //Battery reference voltage pin
        pinBaro = pinMAP;
